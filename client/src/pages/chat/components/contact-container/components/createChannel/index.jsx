...
import { CREATE_CHANNEL_ROUTE, GET_ALL_CONTACTS_ROUTE, SEARCH_CONTACT_ROUTES } from "@/utils/constant";
        ...
        <DialogContent className="bg-[#181120] border-none text-white w-[400px] h-[400px] flex flex-col">
          ...
          <div>
            <MultipleSelector
               ...
               emptyIndicator= {
                <p className="text-center text-large leading-10 text-gray-600">No result found</p>
               }
            />
          </div>
