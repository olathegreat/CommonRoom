...
const Profile = () => {
  ...
  return (
    <div className="bg-[#1b1c24] h-[100vh] flex items-center justify-center flex-col gap-10">
      <div className="flex flex-col items-center gap-10 w-[80vw] md:w-max">
        <div className="w-full">
          ...
          <div className="flex flex-col xs:flex-row items-center gap-5">
            ...
            >
              ...
              {imageRequestLoading && (
                <div className="absolute inset-0 flex items-center justify-center text-white z-50 bg-black/50 rounded-full cursor-pointer ring-fuchsia-50">
                  <Spinner size="medium" />
                </div>
              )}
              ...
              {hovered && (
                <div
                  onClick={image ? handleDeleteImage : fileInputClick}
        ...
        <div className="w-full">
          ...
          >
            {profileRequestLoading ? <Spinner size="medium" /> : "Save Changes"}
          </Button>
        </div>
      </div>
    </div>
